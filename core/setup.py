...
extras_require = {
    "ray": [
        "ray[default]>=2.10.0,<=2.34",  # sync with common/src/autogluon/common/utils/try_import.py
    ],
    "raytune": [
        "ray[default,tune]>=2.10.0,<=2.34",  # sync with common/src/autogluon/common/utils/try_import.py
